...
const project4 = () => {
 ...
 <div className="flex flex-col items-center justify-center text-center md:text-left w-full md:w-[50%]">
   ...
   <div className="flex items-center text-gray-300 font-raleway space-x-4 text-sm md:text-lg">
     ...
     />
     <p>AI-Powered Engagement App</p>
   </div>
   
   {/* Larger About Us text below */}
   <p className="mt-6 text-3xl md:text-5xl font-bold font-sans text-center">AI-Powered Engagement App</p>
 </div>
 ...
 <div className="bg-[#202124] mx-auto my-12 md:my-28 h-auto max-w-[90%] md:max-w-[850px] rounded-lg overflow-hidden">
   ...
   <div className="h-[300px] md:h-[400px] w-full">
     <img
       ...
       src="https://cdn.prod.website-files.com/6320125ace536b6ad148eca3/672207610b973f9aacbad8e0_Features%20of%20AI%20Powered%20Apps.webp"
       alt="Branding"
     />
   </div>
   ...
   <div className="px-10 py-6">
     ...
     We developed an advanced mobile application that harnesses the power of artificial intelligence to transform the user experience. This app is designed to enhance engagement by offering personalized recommendations based on each user's unique preferences, behavior, and interactions.</p>
     {/* Paragraph 2 */}
     <p className="text-[#c8c8c8] font-semibold font-raleway text-sm md:text-[16px] leading-6 md:leading-7 mb-6">
     It leverages AI to analyze data in real time, continuously learning and adapting to optimize the content and features displayed to each individual user. Whether it's suggesting products, services, or content, the app tailors its suggestions to ensure relevance, improving overall user satisfaction and retention.     </p>

     {/* Key Points Section */}
     <div className="mb-6">
       <h2 className="text-gray-200 font-bold text-base font-raleway md:text-lg mb-4">
       we’ve created a solution that not only meets users' immediate needs but anticipates their future ones, making it an indispensable tool for businesses looking to create long-lasting connections with their audience      </h2>
       <div className="flex flex-col space-y-4">
         {[
           "Personalized Recommendations",
           "Real-Time Data Analysis",
           "Improved User Satisfaction",
           "Future Needs Anticipation",
     ...
     <a href="https://www.zitima.com/" target="_blank">
...
<div className="w-full flex justify-center items-center mt-8 bg-[#18191a] ">
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full px-6">
   ...
   <div className="relative group">
     <img
       src="https://www.buzzybrains.com/blog/wp-content/uploads/2024/06/AI-Powered-Mobile-App-Development.jpg"
   ...
   <div className="relative group">
     <img
       src="https://www.shutterstock.com/image-photo/woman-use-power-ai-on-600nw-2342748377.jpg"
   ...
   <div className="relative group">
     <img
       src="https://w0.peakpx.com/wallpaper/497/154/HD-wallpaper-ai-in-app-development-techniques-to-drive-transformation-artificial-intelligence-ai-in-mobile-app-development-ai-in-mobile-apps-ai-in-app-development.jpg"
...
<div className="w-full bg-gradient-to-r from-[#23272b] to-[#2d2f31] py-14 px-8 mb-12">
 ...
 <div className="w-full max-w-4xl mx-auto bg-[#2d2f31] rounded-lg shadow-2xl p-8 space-y-6">
   <div className="flex flex-col items-center text-center">
     ...
     />
     <h3 className="text-2xl text-white font-semibold mb-2 font-raleway tracking-wide">James Patterson</h3>
     ...
     "Working with this team was a fantastic experience. The AI-powered personalized features of the mobile app truly transformed the user engagement for our platform. The seamless interface and intelligent recommendations have significantly enhanced customer satisfaction. Our users now experience a much more tailored journey, and we’ve seen increased retention rates. We couldn’t have asked for a better partner to bring our vision to life</p>
